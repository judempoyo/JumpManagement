            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                <table class="w-full">
                    <tr class="border-b border-gray-200">
                        ...
                        <td class="py-2 text-right font-medium">{{ number_format($invoice->total, 2, ',', ' ') }} $
                        </td>
                    </tr>
                    <tr class="border-b border-gray-200">
                        <td class="py-2 text-gray-600">Remise:</td>
                        <td class="py-2 text-right font-medium">{{ number_format($invoice->discount, 2, ',', ' ') }} $
                        </td>
                    </tr>
                    <tr class="border-b border-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="py-2 text-right">
                            <span
                                class="px-2 py-1 rounded-full text-xs font-medium {{ $invoice->paid ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                                {{ $invoice->paid ? 'Payée' : 'En attente' }}
                            </span>
                            <span
                                class="px-2 py-1 rounded-full text-xs font-medium {{ $invoice->delivered ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
